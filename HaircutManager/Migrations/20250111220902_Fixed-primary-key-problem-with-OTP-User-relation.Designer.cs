...
namespace HaircutManager.Migrations
{
    ...
    [Migration("20250111220902_Fixed-primary-key-problem-with-OTP-User-relation")]
    partial class FixedprimarykeyproblemwithOTPUserrelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HaircutManager.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("InactiveLogoutEnabled")
                        .HasColumnType("tinyint(1)");

                    b.Property<TimeSpan>("InactiveTimeUntilLogout")
            ...
            modelBuilder.Entity("HaircutManager.Models.Audit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HaircutManager.Models.OldPassword", b =>
                {
                    b.Property<Guid>("id")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HaircutManager.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
